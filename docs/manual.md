...
**当日以外のグラフ**（**当日のグラフ** ではない **日毎グラフ**）は、 **完成したグラフ**（後述）のみ加点の対象になります。
...
まず、任意の **日毎グラフ**（`G`）、`G` の前日の **日毎グラフ**（`G-1`）、`G` の前々日の **日毎グラフ**（`G-2`）を考えます。次の 2 つの条件をチェックします。
...
3. 2021-08-05 09:00:00 が **仮想現在時刻** であるとき、2021-08-04 の **日毎グラフ** で 14 時のデータポイントにデータが確認されると、2021-08-03 以前の **日毎グラフ** が全て **完成したグラフ** とみなされます。
   - この時、2021-08-04 の **日毎グラフ** は **完成したグラフ** とはみなされません。
